...
RUN --mount=type=cache,id=s/18a12817-2a84-497b-83f3-00d080bc4f8e-apt-cache,target=/var/cache/apt,sharing=locked \
  --mount=type=cache,id=s/18a12817-2a84-497b-83f3-00d080bc4f8e-apt-lists,target=/var/lib/apt/lists,sharing=locked \
  apt-get update \
  && apt-get upgrade -y \
...
# broken image.
RUN --mount=type=cache,id=s/18a12817-2a84-497b-83f3-00d080bc4f8e-npm-cache,target=/root/.npm \
...
COPY . ./
RUN --mount=type=cache,id=s/18a12817-2a84-497b-83f3-00d080bc4f8e-next-cache,target=/app/.build/next/cache \
